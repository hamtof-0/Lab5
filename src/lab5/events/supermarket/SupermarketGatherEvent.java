 ...
 * 
 * The event that is executed when a customer is done gathering their stuff
 */
public class SupermarketGatherEvent extends SupermarketEvent {
     ...
     * Constructor
     * 
     * @param eventQueue The general queue that hold the events in the order they should be executed
